...
/// <summary>
/// Minimal fake VS-side RPC target shared by tests that exercise the real named-pipe transport
/// (see <see cref="VsixRegistrationPipeListenerTests"/>, <see cref="EndToEndRoundTripTests"/>).
/// Every method throws except GetActiveDocumentAsync, which is the one currently exercised.
/// </summary>
internal sealed class FakeVisualStudioSessionRpc : IVisualStudioSessionRpc
{
