...
This is a Codex adapter for the repository's agent-neutral Visual Studio debugging guide.

Read and follow [../../../.agents/skills/debug-visual-studio.md](../../../.agents/skills/debug-visual-studio.md). Treat that file as the canonical workflow and source of truth.
