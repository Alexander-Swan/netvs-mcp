...
This is a Codex adapter for the repository's agent-neutral Visual Studio build, output, and package guide.

Read and follow [../../../.agents/skills/build-visual-studio.md](../../../.agents/skills/build-visual-studio.md). Treat that file as the canonical workflow and source of truth.
