# Threads, Parallel State, And Exceptions
...
Some debug engines do not expose thread freeze/thaw or stack frames through EnvDTE. If a response says `supported: false`, report it and continue with available state.
