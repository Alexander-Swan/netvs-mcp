...
public sealed class BrokerRuntime
{
    ...
    internal VisualStudioLauncher Launcher { get; }
    ...
    internal BestPracticeGuideCatalog BestPracticeGuides { get; }
